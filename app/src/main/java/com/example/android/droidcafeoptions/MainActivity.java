...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "answer for question";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG,"R1 :menu_main.xml") ;
        Log.d(TAG,"R2:onOptionsItemSelected(MenuItem item) ") ;
        Log.d(TAG,"R3:myAlertBuilder.setTitle(\"Alert\"); ") ;
        Log.d(TAG,"R4 :Dans la méthode onCreateDialog() dans l'extension de DialogFragment") ;
